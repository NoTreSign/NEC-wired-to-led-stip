...
#define pin_output 2
#define one_output 1680
#define zero_output 560
...
const char command_to_send[24][14] PROGMEM={
  {8,4,1,5,8,6},
  {8,4,1,3,1,1,6,1,1,6},
  {8,4,1,3,8,8},
  {8,4,1,4,8,7},
...
const char command_to_send2[48][16] PROGMEM={
  {8,8,6,1,1,6,1,1},
  {8,9,5,1,2,5,1,1},
...
void setup() {
  ...
  BT.begin(baudrate);
  Serial.print(F( "type #<command>$ , mode selected:"));
...
//    Serial.print("got end \t");
    ...
    {
      Serial.print(F("wrong message received \n"));
      commands(message);
      receivedStart=false;
      gotCommand=false;
      message=' ';  
...
//Serial.println(user_input);
  ...
  {
    if(user_input == "on"){
      Serial.print(F("ON selected"));
      mode=0;
    }
    if(user_input == "off"){
      Serial.print(F("OFF selected"));
      mode=1;
    }
    if(user_input == "+dim"){
    ...
    if(user_input == "Red"){
      Serial.print(F("RED selected"));
      mode=4;
    }
    if(user_input == "Green"){
      Serial.print(F("GREEN selected"));
      mode=5;
    }
    if(user_input == "Blue"){
      Serial.print(F("BLUE selected"));
      mode=6;
    }
    if(user_input == "White"){
      Serial.print(F("WHITE selected"));
      mode=7;
    }
    if(user_input == "Flash"){
      Serial.print(F("FLASH selected"));
      mode=8;
    }
    if(user_input == "Strobe"){
      Serial.print(F("STROBE selected"));
      mode=9;
    }
    if(user_input == "Fade"){
      Serial.print(F("FADE selected"));
      mode=10;
    }
    if(user_input == "Smooth"){
      Serial.print(F("SMOOTH selected"));
      mode=11;
    }
    if(user_input == "x0y0"){
      Serial.print(F("x0y0 selected"));
      mode=12;
    }
    if(user_input == "x1y0"){
      Serial.print(F("x1y0 selected"));
      mode=13;
    }
    if(user_input == "x2y0"){
      Serial.print(F("x2y0 selected"));
      mode=14;
    }
    if(user_input == "x0y1"){
      Serial.print(F("x0y1 selected"));
      mode=15;
    }
    if(user_input == "x1y1"){
      Serial.print(F("x1y1 selected"));
      mode=16;
    }
    if(user_input == "x2y1"){
      Serial.print(F("x2y1 selected"));
      mode=17;
    }
    if(user_input == "x0y2"){
      Serial.print(F("x0y2 selected"));
      mode=18;
    }
    if(user_input == "x1y2"){
      Serial.print(F("x1y2 selected"));
      mode=19;
    }
    if(user_input == "x2y2"){
      Serial.print(F("x2y2 selected"));
      mode=20;
    }
    if(user_input == "x0y3"){
      Serial.print(F("x0y3 selected"));
      mode=21;
    }
    if(user_input == "x1y3"){
      Serial.print(F("x1y3 selected"));
      mode=22;
    }
    if(user_input == "x2y3"){
      Serial.print(F("x2y3 selected"));
      mode=23;
    }
  }else{
    if(user_input == "toggle"){
      Serial.print(F("TOGGLE on/off selected"));
      mode=0;
    }
    if(user_input == "pauze"){
      Serial.print(F("PAUZE selected"));
      mode=1;
    }
    ...
    if(user_input == "x3y0"){
      Serial.print(F("x3y0 selected"));
      mode=10;
    }
    if(user_input == "x4y0"){
      Serial.print(F("x4y0 selected"));
      mode=11;
    }
    if(user_input == "x1y1"){
      Serial.print(F("x1y1 selected"));
    ...
    if(user_input == "x3y1"){
      Serial.print(F("x3y1 selected"));
      mode=14;
    }
    if(user_input == "x4y1"){
      Serial.print(F("x4y1 selected"));
      mode=15;
    }
    if(user_input == "x1y2"){
      Serial.print(F("x1y1 selected"));
    ...
    if(user_input == "x3y2"){
      Serial.print(F("x3y2 selected"));
      mode=18;
    }
    if(user_input == "x4y2"){
      Serial.print(F("x4y2 selected"));
      mode=19;
    }
    if(user_input == "x1y3"){
      Serial.print(F("x1y3 selected"));
    ...
    if(user_input == "x3y3"){
      Serial.print(F("x3y3 selected"));
      mode=22;
    }
    if(user_input == "x4y3"){
      Serial.print(F("x4y3 selected"));
      mode=23;
    }

    if(user_input == "SB1"){
      Serial.print(F("RED UP selected"));
      mode=24;
    }
    if(user_input == "SB2"){
      Serial.print(F("GREEN UP selected"));
      mode=25;
    }
    if(user_input == "SB3"){
      Serial.print(F("BLUE UP selected"));
      mode=26;
    }
    if(user_input == "SB4"){
      Serial.print(F("RED DOWN selected"));
      mode=27;
    }
    if(user_input == "SB5"){
      Serial.print(F("GREEN DOWN selected"));
      mode=28;
    }
    if(user_input == "SB6"){
      Serial.print(F("BLUE DOWN selected"));
      mode=29;
    }
    if(user_input == "SB7"){
      Serial.print(F("DIY1 selected"));
      mode=30;
    }
    if(user_input == "SB8"){
      Serial.print(F("DIY2 selected"));
      mode=31;
    }
    if(user_input == "SB9"){
      Serial.print(F("DIY3 selected"));
      mode=32;
    }
    if(user_input == "SB10"){
      Serial.print(F("DIY4 selected"));
      mode=33;
    }
    if(user_input == "SB11"){
      Serial.print(F("DIY5 selected"));
      mode=34;
    }
    if(user_input == "SB12"){
      Serial.print(F("DIY6 selected"));
      mode=35;
    }
    if(user_input == "ab1"){
      Serial.print(F("QUICK selected"));
      mode=36;
    }
    if(user_input == "ab2"){
      Serial.print(F("SLOW selected"));
      mode=37;
    }
    if(user_input == "ab3"){
      Serial.print(F("AUTO selected"));
      mode=38;
    }
    if(user_input == "ab4"){
      Serial.print(F("FLASH selected"));
    ...
    if(user_input == "ab5"){
      Serial.print(F("FADE7 selected"));
      mode=40;
    }
    if(user_input == "ab6"){
      Serial.print(F("FADE3 selected"));
      mode=41;
    }
    if(user_input == "ab7"){
      Serial.print(F("JUMP7 selected"));
      mode=42;
    }
    if(user_input == "ab8"){
      Serial.print(F("JUMP3 selected"));
      mode=43;
    }
...
void send_Message(int modus){
  ...
  if (keymode=='1')
  {
    for (int i = 0; i < sizeof((int)command_to_send[modus]) - 1; i++){
      if (command_to_send_property[i]=='H'){
        high_output((int)command_to_send[modus][i]);
      }else
      {
        low_output((int)command_to_send[modus][i]);
      }   
    }
  }else{
